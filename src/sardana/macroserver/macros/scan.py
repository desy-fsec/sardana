...
class dmesh(mesh):
    ...
    def prepare(self, m1, m1_start_pos, m1_final_pos, m1_nr_interv,
        ...
        mesh.prepare(
            self, m1, start1, final1, m1_nr_interv,
...
class mesh_repeat(mesh):
    ...
    param_def = [
       ...
       ['m1_nr_interv', Type.Integer, None,
        'Number of scan intervals'],
       ['motor2', Type.Moveable, None,
        'Second motor to move'],
    ...
    def prepare(self, m1, m1_start_pos, m1_final_pos, m1_nr_interv,
        ...
        mesh.prepare(
            self, m1, m1_start_pos, m1_final_pos, m1_nr_interv,
            m2, m2_start_pos, m2_final_pos, m2_nr_interv, integ_time,
            bidirectional, **opts)
...
class dmesh_repeat(mesh_repeat):
    ...
    param_def = [
       ...
       ['integ_time', Type.Float,   None, 'Integration time'],
       ['nb_repetitions', Type.Integer, 1, 'Number of repetions per point'],
       ['bidirectional', Type.Boolean, False,
        'Save time by scanning s-shaped']
    ]
